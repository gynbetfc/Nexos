...
# ROTA SEGURA: Só abre se a URL terminar exatamente com o ID do seu dispositivo
...
# GERENCIADOR DO WEBSOCKET LOCAL VIA REAL-TIME LOOP
...
if __name__ == '__main__':
    ...
    print(f"🚀 Servidor Nexos ativo localmente na porta {{PORT}}")
    print(f"🔑 Rota de acesso protegida: http://localhost:{{PORT}}/{{DEVICE_ID}}")
